...
\medskip\noindent
Pour construire $\varphi$, formons le {\it matelas} de la remarque \ref{remark-matress}
...
Soient $F$ et $F'$ des foncteurs apparentés comme dans la définition \ref{definition-siblings}.
Alors
\begin{enumerate}
...
sont apparentés au sens de la définition \ref{definition-siblings},
...
conditions du lemme \ref{lemma-sibling-fully-faithful} et sont donc apparentés.
\end{proof}
