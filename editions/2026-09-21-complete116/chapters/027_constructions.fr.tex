...
du Lemme \ref{lemma-relative-glueing}.
...
\ref{lemma-spec-inclusion} est le
morphisme $\Spec(A) \to \Spec(A'')$
du Lemme \ref{lemma-spec-inclusion}.
\end{lemma}
...
Lemmes \ref{lemma-relative-glueing},
\ref{lemma-spec-inclusion} et
...
$\mathbf{A}^n_S$, sur $S$ ;
voir la Définition \ref{definition-affine-n-space}. En effet,
...
Lemme \ref{lemma-proj-sheaves} comment construire un faisceau quasi-cohérent de modules $\widetilde{M}$
...
Lemme \ref{lemma-where-invertible} que
...
l'image de $f$ par (\ref{equation-global-sections}),
...
D'après le Lemme \ref{lemma-when-invertible},
...
\ref{lemma-converse-construction}). Il suffit
...
Lemme \ref{lemma-proj-valuative-criterion}.
...
Lemme \ref{lemma-surjective-graded-rings-generated-degree-1-map-proj},
$Z'$ est
...
Lemme \ref{lemma-converse-construction},
...
\ref{lemma-morphism-proj-transitive}, puisque
...
Lemme \ref{lemma-glue-relative-proj}
...
Lemme \ref{lemma-transitive-proj}. On obtient ainsi
...
Lemme \ref{lemma-proj-base-change}, le
...
section \ref{section-morphisms-proj}
...
Lemme \ref{lemma-glue-relative-proj} est canoniquement
...
du Lemme \ref{lemma-relative-proj}.
...
\right)
$$
voir le Lemme \ref{lemma-glue-relative-proj-twists}.
...
Lemme \ref{lemma-relative-proj}. Il
...
Lemme \ref{lemma-relative-proj}, comme
...
sur $T$, au sens de la section \ref{section-relative-proj}.
...
\ref{lemma-morphism-relative-proj}
et
...
Lemme \ref{lemma-apply-relative}, appelé
