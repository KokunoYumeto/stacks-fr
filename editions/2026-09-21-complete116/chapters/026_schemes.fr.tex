...
de l'exemple \ref{example-open-subspace} ci-dessus
...
\ref{lemma-isomorphism-locally-ringed}). Notez que $f =
...
\mathcal{O}_Z)$ de l'exemple \ref{example-closed-subspace}
...
\ref{lemma-characterize-closed-subspace} ci-dessus, de ce
...
\ref{lemma-standard-open} ci-dessus, il existe des applications canoniques $M_f
...
\ref{lemma-standard-open} ci-dessus, nous avons une
...
$$
De plus, d'après le lemme \ref{lemma-standard-open} ci-dessus,
...
du lemme \ref{lemma-standard-open}.
...
Dans le lemme \ref{lemma-f-open} ci-dessus, si $X$ est un schéma
...
$$
selon la règle
du lemme \ref{lemma-morphism-into-affine-where-point-goes}. En
...
$D(\psi_Y(g)) \subset X$ qui est ouvert par le lemme \ref{lemma-f-open}. Par
...
voir les lemmes \ref{lemma-spec-sheaves} et \ref{lemma-standard-open}.
...
la démonstration du lemme \ref{lemma-morphism-into-affine-where-point-goes}
...
le lemme \ref{lemma-morphism-into-affine-where-point-goes}
...
\begin{proof}
Cela découle maintenant clairement de la définition \ref{definition-affine-scheme}
et du lemme \ref{lemma-morphism-into-affine}.
\end{proof}
...
est isomorphe à $U$ d'après le lemme \ref{lemma-open-immersion}.
\end{proof}
...
\begin{proof}
Ceci est simplement une application du lemme \ref{lemma-morphism-into-affine}. Tout
...
propriété du faisceau. Par le lemme \ref{lemma-morphism-into-affine}, il
...
(définition \ref{definition-structure-sheaf}) et le faisceau
...
En utilisant le lemme \ref{lemma-compare-constructions}
...
localisations de $R$ (lemme \ref{lemma-spec-sheaves}) et donc
...
Démonstration de (1). D'après le lemme \ref{lemma-compare-constructions}, pour
...
description des fibres de $\widetilde{M}$ (soit dans le lemme \ref{lemma-spec-sheaves}
...
N)$. Ainsi, par le lemme \ref{lemma-compare-constructions}, nous
...
lemme \ref{lemma-compare-constructions}. La troisième égalité vaut par
...
$\psi^\sharp : R \to S$ (voir lemme \ref{lemma-category-affine-schemes}).
\begin{enumerate}
...
le lemme \ref{lemma-compare-constructions}
...
\noindent
Le lemme \ref{lemma-widetilde-pullback} ci-dessus dit en particulier que
...
\ref{lemma-standard-open}, par exemple, nous pouvons affiner ce recouvrement en un
...
\ref{lemma-compare-constructions} ci-dessus. En particulier, nous voyons que
$\mathcal{F}_{M_i}(D(f_if_j)) = (M_i)_{f_j}$, etc. De plus,
d'après le lemme \ref{lemma-compare-constructions} ci-dessus, nous
...
lemme \ref{lemma-compare-constructions}, nous obtenons un morphisme de
...
\begin{proof}
Voir les lemmes \ref{lemma-compare-constructions}
et \ref{lemma-quasi-coherent-affine} ci-dessus.
\end{proof}
...
le lemme \ref{lemma-compare-constructions}, nous savons que tout morphisme
...
quasi-cohérents sur $X$. D'après le lemme \ref{lemma-equivalence-quasi-coherent}
...
exact, voir le lemme \ref{lemma-spec-sheaves}. De
...
universelle du lemme \ref{lemma-compare-constructions}) nous obtenons un diagramme
commutatif
$$
\xymatrix{
0 \ar[r] &
...
anneaux locaux, voir la définition \ref{definition-closed-immersion-locally-ringed-spaces}.
Clairement, cela est (isomorphe) au sous-espace fermé associé
au faisceau quasi-cohérent d'idéaux $\widetilde I$, comme dans
l'exemple \ref{example-closed-subspace}.
\end{example}
...
construite dans l'exemple \ref{example-closed-immersion-affines} ci-dessus.
\end{lemma}

\begin{proof}
La vérification est immédiate : d'après le lemme \ref{lemma-closed-immersion},
...
la définition \ref{definition-closed-subspace} et
l'exemple \ref{example-closed-subspace}. Selon
...
quasi-cohérent. D'après nos résultats de la section \ref{section-quasi-coherent-affine},
il est de la forme $\widetilde S$ pour un certain
$R$-module $S$. De plus, comme $\mathcal{O}_X = \widetilde R \to \widetilde
S$ est surjectif, nous voyons d'après le lemme \ref{lemma-extension-quasi-coherent}
...
d'après le lemme \ref{lemma-standard-open-affine}. Cela prouve que chaque point
...
le lemme \ref{lemma-category-affine-schemes}, nous aurions $U \cong X$.
\end{example}
...
\noindent
Dans le lemme \ref{lemma-open-subspace-scheme}, nous avons vu que tout sous-espace ouvert
...
les résultats de la section \ref{section-quasi-coherent-affine}, nous
...
\Spec(R)$. D'après le lemme \ref{lemma-closed-immersion-affine-case},
...
locaux (voir la définition \ref{definition-immersion-locally-ringed-spaces}).
\item Un {\it sous-schéma ouvert} de $X$ est un sous-espace ouvert
de $X$ au sens de la définition \ref{definition-open-subspace} ; un sous-schéma ouvert
de $X$ est un schéma d'après le lemme \ref{lemma-open-subspace-scheme}.
...
locaux (voir la définition \ref{definition-closed-immersion-locally-ringed-spaces}).
\item Un {\it sous-schéma fermé} de $X$ est un sous-espace fermé
de $X$ au sens de la définition \ref{definition-closed-subspace} ; un sous-schéma fermé est
un schéma d'après le lemme \ref{lemma-closed-subspace-scheme}.
...
\noindent
Il résulte des lemmes des sections \ref{section-open-immersion} et
\ref{section-closed-immersion} que toute immersion ouverte (resp. \ fermée) de
...
notion dans le lemme \ref{lemma-characterize-closed-immersions}. Dans
\cite{EGA}, Grothendieck et Dieudonné définissent d'abord les sous-schémas
fermés via la construction de l'exemple \ref{example-closed-subspace}
...
avec un sous-schéma fermé. Il découle du lemme \ref{lemma-closed-subspace-scheme}
...
voir l'exemple \ref{example-closed-subspace}.
...
associé à $\mathcal{I}$, voir le lemme \ref{lemma-closed-immersion}, nous
...
dans la section \ref{section-schemes}.
\end{proof}

\begin{remark}
\label{remark-intersection-affine-opens}
En général, l'intersection de deux ouverts affines dans $X$
n'est pas un ouvert affine. Voir l'exemple \ref{example-affine-space-zero-doubled}.
\end{remark}
...
\begin{proof}
Cela découle du lemme \ref{lemma-basis-affine-opens} ci-dessus
...
définition \ref{definition-standard-covering})
tel que chaque $V_j$ soit un ouvert standard de l'un des $U_i$.
\end{lemma}

\begin{proof}
Choisissez $v \in V$. Alors $v \in U_i$ pour un certain
$i$. D'après le lemme \ref{lemma-standard-open-two-affines} ci-dessus, il existe un
...
lemme \ref{lemma-standard-open} ci-dessus, il suffit de prouver que la condition
de faisceau est satisfaite pour les recouvrements
ouverts standards (définition
\ref{definition-standard-covering}) des éléments
...
$x_i$. Par le
lemme \ref{lemma-basis-affine-opens} il est
affine. Par conséquent, $X$ est une union disjointe finie de schémas affines, et
est donc affine par
le lemme \ref{lemma-disjoint-union-affines}.
\end{proof}
...
\ref{lemma-reduced} ci-dessus. Dans
...
réduit (d'après le lemme \ref{lemma-affine-reduced} ci-dessus). Par construction,
...
D'après le lemme \ref{lemma-affine-reduced}, l'anneau $R/I'$ est
...
de la définition \ref{definition-reduced-induced-scheme}
...
p$. Cela implique $b = 0$ puisque $B$ est réduit (lemme \ref{lemma-reduced} et
...
le lemme \ref{lemma-morphism-into-affine},
...
contenu du lemme \ref{lemma-specialize-points} est, dans ce cadre,
...
\end{slogan}
Dans le lemme \ref{lemma-glue} ci-dessus, supposons que tous les
...
décrit dans l'exemple \ref{example-not-affine} et donc pas affine.
...
de la section \ref{section-glueing-schemes} en termes
...
utilisant le lemme \ref{lemma-morphism-into-affine}, nous constatons que
$$
...
\ref{section-glueing-schemes} suit parce que $\varphi_{jk}|_{U_{ji}
\cap U_{jk}} \circ
...
lemme \ref{lemma-glue-schemes} pour obtenir un schéma
$X$ avec un recouvrement ouvert $X =
\bigcup U_i$ et des isomorphismes $\varphi_i : X_i \to U_i$ avec des propriétés
comme dans le lemme \ref{lemma-glue}. Soit
$\xi_i' = (\varphi_i^{-1})^* \xi_i$. Les conditions
du lemme \ref{lemma-glue} impliquent que $\xi_i'|_{U_i
...
locaux, et que les conditions du lemme \ref{lemma-glue-functors} soient remplacées
par ce qui suit :
\begin{enumerate}
...
\medskip\noindent
D'après le lemme \ref{lemma-morphism-into-affine},
...
\end{eqnarray*}
est représentable. Nous affirmons que le lemme \ref{lemma-glue-functors}
...
exemple la propriété universelle du lemme \ref{lemma-glue}). De plus,
...
\medskip\noindent
Nous vérifions la condition (2)(a) du lemme \ref{lemma-glue-functors}. Cela
découle directement du lemme \ref{lemma-fibre-product-affine-schemes}. (Notez que nous
...
\medskip\noindent
Nous vérifions la condition (2)(b) du lemme \ref{lemma-glue-functors}.
...
\medskip\noindent
Nous vérifions la condition (2)(c) du lemme \ref{lemma-glue-functors}.
...
En utilisant la remarque \ref{remark-representable-locally-ringed},
...
= \Spec(R)$. D'après le lemme \ref{lemma-fibre-product-affine-schemes}, le
...
ce que nous avons fait dans la preuve du lemme \ref{lemma-fibre-products}.)
...
lemme \ref{lemma-characterize-points}. Ce morphisme correspond aux
...
$$
voir la discussion dans la section \ref{section-points}. Ainsi, nous obtenons
...
lemme \ref{lemma-restrict-map-to-closed}, le sous-espace fermé $Z \subset
...
le lemme \ref{lemma-closed-subspace-scheme}, $Z$ est un schéma. Par
conséquent, $Z = X \times_S Y$ et la première affirmation en
découle. La deuxième découle par exemple du lemme \ref{lemma-open-fibre-product}.
...
Voir le lemme \ref{lemma-fibre-product-immersion} ci-dessus.
\end{definition}
...
X$, et le lemme découle du lemme \ref{lemma-fibre-product-immersion}.
\end{proof}
...
le lemme \ref{lemma-morphism-from-spec-local-ring} par exemple. Ainsi,
...
le lemme \ref{lemma-fibre-topological}), nous avons
$$
...
\begin{proof}
Comme dans la preuve du lemme \ref{lemma-fibre-topological}, cela se
...
induite, voir définition \ref{definition-reduced-induced-scheme}.
...
Ainsi $f(X)$ est fermé
par le lemme \ref{lemma-image-quasi-compact-closed}.
\end{proof}
...
La partie (2) découle
des lemmes \ref{lemma-quasi-compact-closed}
et \ref{lemma-quasi-compact-preserved-base-change}.
\end{proof}
...
\ref{lemma-specialize-points} et la
discussion suivant le lemme
\ref{lemma-characterize-points}, cela conduit
...
$f : \Spec(A) \to S$, voir
lemme \ref{lemma-morphism-from-spec-local-ring}. Ce
...
\ref{definition-valuative-criterion}. Pour trouver la flèche en
...
lemme \ref{lemma-characterize-points}. D’après l’hypothèse, il existe
...
\ref{lemma-specialize-points} et la discussion qui suit le lemme
\ref{lemma-characterize-points}. La composée $A \to \mathcal{O}_{X, x}
...
\to X$ (voir le lemme \ref{lemma-morphism-from-spec-local-ring}
...
le lemme \ref{lemma-points-specialize}
...
des lemmes \ref{lemma-specializations-lift} et
\ref{lemma-lift-specializations-valuative} ci-dessus.
\end{proof}
...
sur $k$, voir l'exemple \ref{example-projective-line}. Utilisons
...
selon l'exemple \ref{example-closed-immersion-affines}.
\end{proof}
...
affine dans $X \times_S X$, voir les lemmes \ref{lemma-fibre-product-affines}
et \ref{lemma-open-fibre-product}.
Considérons le sous-schéma ouvert $W$ de $X \times_S X$
qui est l'union de ces ouverts affines $V \times_U V$.
D'après le lemme \ref{lemma-closed-local-target}, il suffit
...
fermée, ce qui est le lemme \ref{lemma-diagonal-affines-closed}.
\end{proof}
...
\noindent
D'après les lemmes \ref{lemma-diagonal-immersion} et \ref{lemma-immersion-when-closed}, nous
...
lemme \ref{lemma-closed-immersion-quasi-compact}, nous voyons qu'un morphisme
...
(recollés comme dans l'exemple \ref{example-affine-space-zero-doubled}).
...
\ref{lemma-base-change-immersion}, \ref{lemma-diagonal-immersion} et de la
...
le lemme \ref{lemma-affine-covering-fibre-product},
...
V_{j'}$. Ainsi, l'implication découle du lemme \ref{lemma-quasi-compact-affine}.
...
$B$. D'après le lemme \ref{lemma-open-fibre-product}, on
voit que $U \times_S V = U \times_W V = \Spec(A \otimes_R
B)$ est un ouvert affine de $X \times_S X$. Par
conséquent, d'après le lemme \ref{lemma-closed-subspace-scheme},
...
ouvert de $X \times_S X$ (voir par exemple\ le lemme \ref{lemma-affine-covering-fibre-product}).
Il suffit donc de montrer que chaque morphisme
$U \cap V = \Delta_{X/S}^{-1}(U \times_S V) \to U \times_S V$ est une
immersion fermée, voir le lemme \ref{lemma-closed-local-target}. D'après
...
conditions (2)(a) et (2)(b) du lemme \ref{lemma-characterize-separated} sont
...
découle des lemmes \ref{lemma-diagonal-immersion},
\ref{lemma-fibre-product-immersion} et
...
\begin{proof}
Il s'agit d'un cas particulier du lemme \ref{lemma-fibre-product-after-map}
...
\begin{proof}
Il s'agit d'un cas particulier du lemme \ref{lemma-semi-diagonal} appliqué
...
second d'après le lemme \ref{lemma-fibre-product-after-map}. Le même argument
...
(Lemmes \ref{lemma-fibre-product-immersion}
et \ref{lemma-quasi-compact-preserved-base-change}).
...
\ref{lemma-fibre-product-after-map}, le dernier
...
est une immersion fermée selon le lemme \ref{lemma-immersion-when-closed}.
...
comme $V$, nous déduisons le lemme du lemme \ref{lemma-characterize-quasi-separated}.
\end{proof}
...
est quasi-compacte d'après le lemme \ref{lemma-section-immersion}
car elle est une section du morphisme quasi-séparé $X \times_Z Y \to X$ (un changement
de base de $g$, voir le lemme \ref{lemma-separated-permanence}). La
deuxième application est quasi-compacte car
elle est le changement de base de $g \circ f$,
voir le lemme \ref{lemma-quasi-compact-preserved-base-change}.
Et les composés de morphismes
quasi-compacts sont quasi-compactes, voir le lemme \ref{lemma-composition-quasi-compact}.
\end{proof}
...
diagonale fermée d'après le lemme \ref{lemma-diagonal-affines-closed}.
Ainsi $U$ est séparé selon la définition \ref{definition-separated}.
Si $U \to X$ est un morphisme de schémas, alors nous pouvons
appliquer le lemme \ref{lemma-compose-after-separated}
...
\begin{proof}
Dans ce cas, $X$ est séparé par le lemme \ref{lemma-separated-permanence}.
Ainsi, $U \cap V$ est affine en
appliquant le lemme \ref{lemma-characterize-separated} au
...
l'exemple \ref{example-not-affine}. D'autre part, considérons le
schéma
$$
...
par les lemmes \ref{lemma-separated-permanence} et
\ref{lemma-composition-quasi-compact} appliqués à
$X \to Y \to \Spec(\mathbf{Z})$. Si $X$ a $P$, alors $f$ l'a aussi par les
lemmes \ref{lemma-compose-after-separated} et
\ref{lemma-quasi-compact-permanence} appliqués à $X
...
\ref{lemma-separated-permanence} et
\ref{lemma-quasi-compact-preserved-base-change}. Par
...
\begin{proof}
Soit un diagramme comme dans la définition \ref{definition-valuative-criterion}
...
lemme \ref{lemma-where-are-they-equal}, ceci est un sous-schéma
...
\begin{proof}
Par l'hypothèse (1),
la proposition \ref{proposition-characterize-universally-closed}, et
les lemmes \ref{lemma-diagonal-immersion} et \ref{lemma-immersion-when-closed},
...
du lemme \ref{lemma-monomorphism} ci-dessus.
\end{proof}
...
démonstration du lemme \ref{lemma-diagonal-immersion}).
\end{proof}
...
lemme \ref{lemma-injective-points-surjective-stalks} s'applique. Plus
élégamment peut-être, nous pouvons utiliser que
les lemmes \ref{lemma-restrict-map-to-opens} et
\ref{lemma-characterize-closed-subspace} impliquent que les
...
\begin{proof}
Résulte du lemme \ref{lemma-immersions-monomorphisms}
et du fait que le composé de morphismes séparés est séparé
(lemme \ref{lemma-separated-permanence}).
\end{proof}
...
avons vu dans
la section \ref{section-quasi-coherent-affine}
...
ouverts affines $U_{ijk}$, voir le lemme \ref{lemma-characterize-quasi-separated}.
...
lemme \ref{lemma-widetilde-pullback}, nous voyons que le deuxième et le
...
du lemme \ref{lemma-injective-points-surjective-stalks}.
Par conséquent, $f : X \to Y$ est un monomorphisme. En particulier,
$f$ est séparé, voir le lemme \ref{lemma-monomorphism-separated}.
Ainsi, le lemme \ref{lemma-push-forward-quasi-coherent}
...
selon le lemme \ref{lemma-extension-quasi-coherent}. Comme un faisceau
...
voir définition \ref{definition-closed-immersion-locally-ringed-spaces}.
\end{proof}
...
d'après le lemme \ref{lemma-characterize-closed-immersions}
