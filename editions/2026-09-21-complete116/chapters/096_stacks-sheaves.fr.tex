...
$f^{-1}$ et $f_*$ de (\ref{equation-functoriality-presheaves-modules})
...
Les constructions du Lemme \ref{lemma-compare} sont compatibles avec la localisation \'etale ;
...
Lemme \ref{lemma-stackification}
et de
...
Comme $U \to F$ est \'etale, la Remarque \ref{remark-compare} donne
$$
...
Lemme \ref{lemma-compare-quasi-coherent}
...
\begin{proof}
D'après le
Lemme \ref{lemma-stackification-quasi-coherent}
le morphisme de champification $[U/_{\!p}R] \to [U/R]$ (voir
Groupoïdes dans les espaces, Définition
\ref{spaces-groupoids-definition-quotient-stack})
induit une équivalence des catégories de faisceaux quasi-cohérents
...
Lemme \ref{lemma-quasi-coherent-algebraic-stack}
...
Lemme \ref{lemma-fibre-products-morphism})
...
Remarque \ref{remark-cech-complex-presheaves}.
\end{proof}
...
\mathcal{K}^\bullet(g, e^{-1}\mathcal{F})$
du
Lemme \ref{lemma-generalities-sheafified}
...
Remarque \ref{remark-cech-complex-sections}.
...
\begin{proof}
D'après le
Lemme \ref{lemma-check-exactness-covering}
il suffit de vérifier l'exactitude après image réciproque sur $\mathcal{U}$.
D'après le
Lemme \ref{lemma-base-change-cech-complex}
...
Lemme \ref{lemma-fibre-products-preserve-properties}
...
Lemme \ref{lemma-pullback-injective}
...
Lemme \ref{lemma-pushforward-injective}.
Par conséquent, la
...
Lemme \ref{lemma-pullback-injective-modules}
au lieu du
Lemme \ref{lemma-pullback-injective}.
\end{proof}
...
Lemme \ref{lemma-cech-to-cohomology-relative}
si ce n'est qu'elle emploie une résolution injective dans
$\textit{Mod}(\mathcal{X}_\tau, \mathcal{O}_\mathcal{X})$
et qu'elle emploie le
Lemme \ref{lemma-pullback-injective-modules}
...
Lemme \ref{lemma-pushforward-restriction}.
\end{proof}
...
résulte du
Lemme \ref{lemma-lqc-flat-base-change-fppf-sheaf}.
...
Lemme \ref{lemma-cohomology-restriction}
nous avons
...
$(\Sch/U)_{fppf}$, voir le Lemme \ref{lemma-localizing}.)
...
Lemme \ref{lemma-quasi-coherent-alternative},
