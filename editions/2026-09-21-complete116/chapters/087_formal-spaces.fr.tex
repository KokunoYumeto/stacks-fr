...
la remarque \ref{remark-sheafification-of-presheaves-in-top}.
...
$h_\mathfrak X$ (voir le lemme \ref{lemma-fully-faithful})
...
Nous avons observé dans la démonstration du lemme \ref{lemma-fully-faithful} 
...
sur cette notion. Les analogues des lemmes \ref{lemma-fully-faithful} et
...
remarque \ref{remark-set-theoretic}).
...
est $N$ (voir le lemme \ref{lemma-closed}). Enfin, $M \to M/N$
...
et l'assertion (2) résulte du lemme \ref{lemma-closure}.
...
le lemme \ref{lemma-quotient-by-closed}.
...
En appliquant le lemme \ref{lemma-ses} à cette surjection et à la
...
\medskip\noindent
Consignons ici les notions introduites dans la remarque \ref{remark-mcquillan}.
...
d'après le lemme \ref{lemma-closed}. Ainsi, $g = f + h$
...
L'adhérence de $IB$ est $\bigcap (IB + J_\lambda)$ d'après le lemme \ref{lemma-closed}.
...
de l'exemple \ref{example-what-does-it-mean}. La limite peut donc
...
le lemme \ref{lemma-topologically-nilpotent}. Ainsi, 
...
\begin{proof}
Les remarques qui suivent la définition \ref{definition-taut} montrent que
...
nilpotents d'après le lemme \ref{lemma-topologically-nilpotent}.
...
(comparer au lemme \ref{lemma-closure-image-ideal}), on conclut.
\end{proof}
...
d'après le lemme \ref{lemma-topologically-nilpotent}. Par conséquent, $J$ est un idéal faible
de définition de $B$.
\end{proof}
...
Voir aussi la section \ref{section-adic}.
...
D'après le lemme \ref{lemma-dense-image-surjective}, $B' \to B$ est ouvert
...
la définition \ref{definition-weakly-adic}, et la condition (1) est vérifiée.
...
D'après les lemmes \ref{lemma-completion-taut} et
...
On conclut par le lemme \ref{lemma-taut-is-adic} (plus précisément, ce
...
\begin{proof}
Nous utilisons la caractérisation du lemme \ref{lemma-weakly-adic}
sans autre mention.
...
On conclut par le lemme \ref{lemma-weakly-adic-finite-generation-bis}.
\end{proof}
...
\begin{proof}
Nous utiliserons la caractérisation du lemme \ref{lemma-weakly-adic}
sans autre mention. D'après le lemme \ref{lemma-completed-tensor-product},
...
le lemme \ref{lemma-weakly-adic}.
D'après le lemme \ref{lemma-taut-descent-admissible},
...
le lemme \ref{lemma-taut-descent-weakly-adic}
(et le lemme \ref{lemma-weakly-adic} pour voir que les anneaux adiques sont faiblement adiques).
Soit $I \subset A$ un idéal de définition.
...
de type fini contenu dans l'adhérence de $IB$. D'après le lemme \ref{lemma-closed},
...
D'après le lemme \ref{lemma-weakly-admissible-henselian}, par exemple,
...
D'après le lemme \ref{lemma-diagonal-affine-formal-algebraic-space},
les morphismes $X_\lambda \to X$ sont représentables.
Étant donné $U \to X$, où $U$ est un schéma,
la discussion qui suit
la définition \ref{definition-affine-formal-algebraic-space}
...
\item une condition ensembliste comme dans la remarque \ref{remark-set-theoretic}.
\end{enumerate}
\end{lemma}

\begin{proof}
Il résulte des lemmes \ref{lemma-covering-by-thickenings} et
...
(voir la remarque \ref{remark-mcquillan}) tel que
...
le lemme \ref{lemma-diagonal-affine-formal-algebraic-space}).
...
d'après le lemme \ref{lemma-factor-through-thickening}.
...
$\Spec(A/I) \to X$ ; voir le lemme \ref{lemma-factor-through-thickening}.
...
du lemme \ref{lemma-mcquillan-affine-formal-algebraic-space}. Soit $A$
...
$$
Voir la discussion de la section \ref{section-weakly-adic} et, pour un énoncé précis,
le lemme \ref{lemma-implications-between-types}.
...
le lemme \ref{lemma-fully-faithful}.
...
le lemme \ref{lemma-formal-scheme-sheaf-fppf}.
Ainsi, $h_\mathfrak X$ est un espace algébrique formel affine.
En fait, c'est un espace algébrique formel affine classique
d'après la définition \ref{definition-types-affine-formal-algebraic-space}.
Le lemme \ref{lemma-fully-faithful} nous dit donc que
...
$S$ ; voir la définition \ref{definition-weakly-admissible}\footnote{Voir
Compléments d'algèbre, définition
\ref{more-algebra-definition-topological-ring}
pour le cas classique, et la remarque \ref{remark-mcquillan}
...
le lemme \ref{lemma-factor-through-thickening},
...
lemme \ref{lemma-completion-affine-is-affine-formal-algebraic-space}.
\end{proof}
...
remarque \ref{remark-weak-ideals-of-definition}
...
lemme \ref{lemma-closure-image-ideal}.
...
(lemme \ref{lemma-implications-between-types})
...
lemmes \ref{lemma-iff-countably-indexed},
\ref{lemma-iff-cic},
...
(exemple \ref{example-reduction-affine-formal-spectrum})
