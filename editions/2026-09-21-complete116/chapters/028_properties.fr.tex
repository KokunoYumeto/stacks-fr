...
et donc $E$ constructible (lemme \ref{lemma-locally-constructible}).
...
ainsi
que du lemme \ref{lemma-quasi-separated-quasi-compact-open-retrocompact}
ci-dessus.
\end{proof}
...
le lemme \ref{lemma-quasi-separated-quasi-compact-open-retrocompact}.
Ainsi,
...
le lemme \ref{lemma-characterize-reduced} ci-dessus. Ainsi $R$ est réduit
...
réduit, donc $X$ est réduit par le lemme \ref{lemma-characterize-reduced}.
De plus, tout ouvert affine non vide est irréductible. Par
conséquent, $X$ est irréductible, voir le lemme \ref{lemma-characterize-irreducible}.
\end{proof}
...
la définition \ref{definition-property-local} (1), on obtient $P(R_{f_j})$.
...
la seconde condition de la définition \ref{definition-property-local}.
\end{proof}
...
lemme \ref{lemma-immersion-into-noetherian} ci-dessus,
...
comme dans le lemme \ref{lemma-maximal-points}, dont nous utiliserons les
...
une propriété locale des anneaux, voir le lemme \ref{lemma-locally-P}.
...
démontre la seconde condition de la définition \ref{definition-property-local}.
\end{proof}
...
le lemme \ref{lemma-locally-jacobson}.
...
lemme \ref{lemma-normal-locally-finite-nr-irreducibles}, car l'espace
...
normal (lemme \ref{lemma-integral-normal}), on obtient
...
combinant ce résultat avec le lemme \ref{lemma-locally-Noetherian},
...
la section \ref{section-catenary}, que, si $Y \subset X$ est un fermé
...
\begin{proof}
Cela résulte du lemme \ref{lemma-locally-P} et des
...
la définition \ref{definition-integral}).
...
japonais par hypothèse ; le lemme \ref{lemma-locally-Japanese} montre donc que
...
le lemme \ref{lemma-locally-Noetherian-closed-point},
...
noethérien (lemme \ref{lemma-locally-Noetherian}) $\mathcal{O}_X(U)$ est un
...
la définition \ref{definition-unibranch}. C'est le cas, par exemple,
...
le lemme \ref{lemma-characterize-integral}.
...
Le lemme \ref{lemma-finite-type-module} montre que $M$ est un $R$-module de
...
fini. Donc, de nouveau par le lemme \ref{lemma-finite-type-module},
...
(\ref{equation-module-invert-s}) est un isomorphisme.
\end{enumerate}
...
le lemme \ref{lemma-invert-f-sections}, on obtient
...
l'aide des lemmes \ref{lemma-finite-type-module} et
...
le lemme \ref{lemma-invert-f-sections} ci-dessus.
\end{proof}
...
un isomorphisme sur $D(f) \subset \Spec(A)$. De nouveau par le lemme \ref{lemma-invert-f-affine},
$j$ envoie $U_f$ isomorphiquement sur $D(f)$. On obtient donc
$U_f = U_f \times_{\Spec(B)} \Spec(A)$. Puisque le
lemme \ref{lemma-quasi-affine} permet de recouvrir $U$ par des $V_g = U_f$ comme
...
utilise les lemmes \ref{lemma-finite-type-module},
...
le lemme \ref{lemma-finite-type-module}.
...
démonstration du lemme \ref{lemma-extend}. Nous le détaillons néanmoins.
...
Le lemme \ref{lemma-extend} permet de
...
le lemme \ref{lemma-finite-presentation-module},
...
quasi-cohérent, d'après le lemme \ref{lemma-extend-trivial},
...
lemme \ref{lemma-directed-colimit-diagram-finite-presentation} et
...
présentation finie (lemme \ref{lemma-directed-colimit-finite-presentation}).
...
le lemme \ref{lemma-directed-colimit-finite-presentation}.
...
$\mathcal{I}_i$, voir
le lemme \ref{lemma-quasi-coherent-colimit-finite-type}.
...
comme dans le lemme \ref{lemma-algebra-directed-colimit-finite-presentation}.
...
l'aide du lemme \ref{lemma-directed-colimit-finite-presentation}.
...
la démonstration
du lemme \ref{lemma-finite-algebra-directed-colimit-finite-finitely-presented}).
Enfin, on a
$$
...
le lemme \ref{lemma-colimit-kappa}. Choisissons une famille
...
le lemme \ref{lemma-extend}, il existe un sous-faisceau quasi-cohérent
...
fini $I \subset R$, voir le lemme \ref{lemma-finite-type-module}.
...
le lemme \ref{lemma-sections-annihilated-by-ideal} ci-dessus est
...
bien que le lemme \ref{lemma-sections-annihilated-by-ideal} s'applique
...
le lemme \ref{lemma-sections-supported-on-closed-subset} est appelé
...
quasi-cohérent. Le lemme \ref{lemma-sections-supported-on-closed-subset}
...
affichée du lemme \ref{lemma-sections-over-quasi-compact-open-in-affine}.
...
le lemme \ref{lemma-sections-over-quasi-compact-open-in-affine}
...
lemme \ref{lemma-affine-s-opens-cover-quasi-separated} et
de la définition \ref{definition-ample}.
\end{proof}
...
\item
\label{item-c-i-q}
même propriété qu'en (\ref{item-c-q}), où $\mathcal{F}$ parcourt tous les
...
\medskip\noindent
Supposons (\ref{item-c-gg}). Soit $\mathcal{F}$ un faisceau
quasi-cohérent de $\mathcal{O}_X$-modules de type fini.
...
conclut donc que (\ref{item-c-i-q}) entraîne (\ref{item-qc-i-gg}).
...
le lemme \ref{lemma-quasi-affine-O-ample}.
Alors $\mathcal{O}_{X'}$ est ample d'après
le lemme \ref{lemma-ample-on-locally-closed}. Donc $X'$ est quasi-affine d'après
le lemme \ref{lemma-quasi-affine-O-ample}.
\end{proof}
...
le lemme \ref{lemma-quasi-affine-O-ample} ci-dessus.
Considérons l'immersion ouverte
$$
...
le lemme \ref{lemma-invert-f-affine}. Puisque les $f_i$ engendrent l'idéal
...
irréductibles, on peut appliquer le lemme \ref{lemma-maximal-points-affine} ci-dessus,
...
le lemme \ref{lemma-ample-finite-set-in-affine}, on peut choisir un ouvert
...
le lemme \ref{lemma-quasi-affine-O-ample} et
la proposition \ref{proposition-characterize-ample},
on voit que tout
...
D'après le lemme \ref{lemma-ample-finite-set-in-affine} ou
le lemme \ref{lemma-ample-finite-set-in-principal-affine},
