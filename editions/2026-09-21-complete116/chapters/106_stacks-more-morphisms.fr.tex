...
(\ref{equation-morphism}) dans la catégorie $\textit{Espaces}/\mathcal{X}'$
...
le lemme \ref{lemma-easy-kunneth} donne la première égalité de
$$
g_{\QCoh, *}\mathcal{O}_U
\otimes_{\mathcal{O}_\mathcal{X}}
g_{\QCoh, *}\mathcal{O}_U
...
lemme \ref{lemma-affine}. Puisque $A \to R$ est plat (car
$\text{pr}_2$ est plat en tant que changement de base de $U \to \mathcal{X}$),
nous concluons que $C \otimes_B C$ est plat sur $C$.
D'après le lemme \ref{lemma-flat}, nous concluons que $B \to C$ est fidèlement plat.
...
du lemme \ref{lemma-affine}. Les détails sont omis.
\end{proof}
