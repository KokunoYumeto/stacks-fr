...
théorème de finitude de Grothendieck; voir Théorème \ref{theorem-finiteness}
et Lemme \ref{lemma-finiteness-Rjstar} (images directes supérieures
...
pour $p \geq 1$. Par Lemme \ref{lemma-local-cohomology-is-local-cohomology},
...
Lemme \ref{lemma-multiplicative}.
...
Par Lemme \ref{lemma-elements-come-from-bigger}, nous pouvons agrandir $I''$,
...
Par Lemme \ref{lemma-local-cohomology},
...
Lemme \ref{lemma-depth-2-connected-punctured-spectrum},
...
Lemme \ref{lemma-local-cohomology}.
...
\medskip\noindent
Si $d > 0$, Lemme \ref{lemma-local-cohomology} montre immédiatement
...
de Lemme \ref{lemma-cd} est appelé la
...
soit de Lemme \ref{lemma-local-cohomology-is-local-cohomology}.
Pour (3), nous utilisons Lemme \ref{lemma-cd}
...
Lemme \ref{lemma-cd-local}, nous pouvons supposer $A$ local.
...
ce qui donne le résultat par Lemme \ref{lemma-cd}.
...
\begin{proof}
Cela résulte de Lemme \ref{lemma-cd} et de
...
Lemme \ref{lemma-bound-cd}. Donc $H^d_\mathfrak m(A)$ est
...
Par Lemme \ref{lemma-cd-change-rings},
...
\begin{proof}
Par Lemme \ref{lemma-cd-change-rings}, nous avons
...
Par Lemme \ref{lemma-cd-maximal}, ceci est égal à $\dim(A/\mathfrak p)$.
\end{proof}
...
la sous-catégorie de Serre décrite dans Lemme \ref{lemma-support}.
...
Lemme \ref{lemma-cd-dimension}.
Par Lemme \ref{lemma-adjoint-ext}, nous obtenons que $H^0_T$ est de
...
Lemme \ref{lemma-equal-plus}. Cependant, comme $H^0_T$ est de dimension
...
Lemmes \ref{lemma-adjoint}, \ref{lemma-adjoint-ext},
\ref{lemma-equal-plus} et \ref{lemma-equal-full}.
\end{remark}
...
aux sommes directes dans $D(A)$, par exemple par Lemme \ref{lemma-adjoint-ext},
...
Lemme \ref{lemma-local-cohomology-ss}.
...
pour un fermé $Z \subset T$; voir Lemme \ref{lemma-adjoint-ext}.
...
H^i_{\mathfrak p A_\mathfrak p}(M_\mathfrak p)
$$
par Lemme \ref{lemma-filter-local-cohomology}.
...
$$
est pro-nul par Lemme \ref{lemma-zero}; on utilise ici que la fonction
...
Lemme \ref{lemma-adjoint-ext}. Comme $H^i_T(M)$ est de type fini
...
Remarque \ref{remark-upshot}. Il en résulte que
...
pour $i \leq n$. Par
Lemme \ref{lemma-check-finiteness-local-cohomology-by-annihilator},
...
Lemme \ref{lemma-check-finiteness-local-cohomology-by-annihilator}.
Puis Lemme \ref{lemma-annihilate-local-cohomology}
...
\begin{proof}
Cette proposition est la généralisation naturelle de la proposition \ref{proposition-annihilator}, dont le lecteur est invité à lire d'abord la démonstration. Soit $\omega_A^\bullet$ un complexe dualisant. Soit $\delta$ sa fonction de dimension ; voir Complexes dualisants, section \ref{dualizing-section-dimension-function}. Les $A$-modules de type fini
$$
