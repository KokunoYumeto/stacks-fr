...
\title{Catégories dérivées des espaces}
...
\noindent
Soit $X$ un schéma. Avec les notations de (\ref{equation-epsilon}),
...
découle du
lemme \ref{lemma-check-quasi-coherence-on-covering}
...
au moyen du lemme \ref{lemma-derived-quasi-coherent-small-etale-site} et de la
...
Zariski et \'etale co\"incident; voir le lemme \ref{lemma-descend-perfect}.
...
que pour un nombre fini d'indices, d'apr\`es le lemme \ref{lemma-ext-from-perfect-into-bounded-QCoh}.
...
$D_\QCoh(\mathcal{O}_X)$; voir la proposition \ref{proposition-compact-is-perfect}.
Avec (\ref{equation-E-is-OK}), l'argument du lemme d'Alg\`ebres diff\'erentielles
...
\ref{lemma-tensor-with-QCoh-complex} donne pr\'ecis\'ement ce foncteur
$$
- \otimes_E^\mathbf{L} K^\bullet :
...
r\'esultat d\'ecoule assez facilement du lemme \ref{lemma-cohomology-base-change}.
