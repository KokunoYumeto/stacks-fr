...
dans $D(\mathcal{O}_S)$.
La propriété d'être parfait satisfaisant à la propriété des deux sur trois
...
à une somme directe d'un nombre de copies égal au nombre de choix, parmi $n + 1$ éléments, de $p$ éléments, de $\mathcal{O}(-p)$,
...
des sous-schémas ouverts de changements de base des fibres des morphismes $Y_i \to X_i$ ; elles sont donc
finies et localement intersections complètes (voir
