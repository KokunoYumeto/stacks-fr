...
$$
dans Algebra, Section \ref{algebra-section-netherlander}.
...
More on Algebra, Lemma \ref{more-algebra-lemma-tensor-hom-adjoint}, et
la seconde de
...
Écrivons $B = A[x_1, \ldots, x_n]/J$. D'après More on Algebra, Definition
...
$$
Puisque $J/J^2$ est projectif (More on Algebra, Lemma
...
D'après More on Algebra, Lemma \ref{more-algebra-lemma-lci-NL},
le complexe $\NL_{B/A}$ est parfait, d'amplitude de Tor contenue dans
$[-1, 0]$. Il s'ensuit que notre $\Ext^2$ s'annule, par exemple
d'après More on Algebra, Lemma \ref{more-algebra-lemma-splitting-unique}, partie (1).
\end{proof}
...
Comparer avec Algebra, Item \ref{algebra-item-ideal-locally-nilpotent}.
...
voir Modules, Lemma \ref{modules-lemma-i-star-equivalence}.
...
\Hom_{\mathcal{O}_{X'}}(\mathcal{F}', \mathcal{G})
$$
voir Homology, Lemma \ref{homology-lemma-check-exactness}.
\end{proof}
