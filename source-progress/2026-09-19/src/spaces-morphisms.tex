...
a été défini dans Properties of Spaces, Section
...
d'après Properties of Spaces, Section
...
$$
voir Properties of Spaces, Lemma
...
Nous pouvons donc appliquer Properties of Spaces, Lemma
\ref{spaces-properties-lemma-subspaces-presentation}
...
$$
(la première et la dernière égalité résultant de Cohomology of Schemes,
...
D'après Morphisms, Lemma \ref{morphisms-lemma-reach-points-scheme-theoretic-image},
...
\begin{proof}
Nous utiliserons la caractérisation de Morphisms, Lemma
...
(voir Morphisms, Section \ref{morphisms-section-etale}).
