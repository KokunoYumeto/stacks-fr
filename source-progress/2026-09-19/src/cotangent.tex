...
$V : \textit{Alg}_A \to \textit{Sets}$ est le foncteur d'oubli et où
$U : \textit{Sets} \to \textit{Alg}_A$ associe à un ensemble $E$ l'algèbre
...
$V : A\textit{-Alg} \to \textit{Sets}$ et son adjoint
$U : \textit{Sets} \to A\textit{-Alg}$ commutent aux colimites filtrantes.
