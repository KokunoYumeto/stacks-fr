...
d'un schéma $U$ est précisément la catégorie $\textit{Spaces}/U$ des
...
de $\textit{Spaces}/U_i$ tels que les restrictions de $\varphi_i$ et $\varphi_j$
...
\noindent
Soit $F : (\Sch/S)_{fppf}^{opp} \to \textit{Sets}$ un préfaisceau.
...
\medskip\noindent
En général, $G\textit{-Principal-Schemes}$ n'est pas
...
\medskip\noindent
En général, $G\textit{-Torsors-Schemes}$ n'est pas
un champ en groupoïdes sur $(\Sch/S)_{fppf}$. Cela tient
