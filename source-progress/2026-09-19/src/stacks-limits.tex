...
$p : \mathcal{X} \to \mathcal{Y}$ commute aux limites, il en va de même de
son changement de base
...
(1) et (2). Un sens a été établi dans le lemme
\ref{lemma-limit-preserving-objects}. Pour l'autre, soit
...
$\{T_i \to T\}_{i \in I}$ et à une donnée de descente $[U/R]$
...
$(u_{\lambda, i}, r_{\lambda, ij})$ est une donnée de descente $[U/R]$
...
\begin{reference}
C'est un cas particulier de \cite[Lemma 2.3.15]{Emerton-Gee}.
\end{reference}
...
\section{Immersion fermée du type fini dans la présentation finie}
