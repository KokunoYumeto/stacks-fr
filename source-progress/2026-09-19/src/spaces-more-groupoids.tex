...
\end{equation}
les deux carrés inférieurs sont des carrés de produits fibrés.
...
\noindent
Supposons donné un groupoïde $(\text{Ob}, \text{Arrows}, s, t, c, e, i)$.
On peut alors construire un monoïde $\Gamma$ dont les éléments sont les
applications $\delta : \text{Ob} \to \text{Arrows}$ telles que
...
Soit $k$ un corps de clôture algébrique $\overline{k}$.
...
cela correspond à un septuple $(\text{Ob}, \text{Arrows}, s, t, c, e, i)$.
...
$Z \subset \text{Arrows}$ possédant les propriétés suivantes :
\begin{enumerate}
