...
\begin{enumerate}
\item La catégorie $\textit{Sets}$ des ensembles.
\item La catégorie $\textit{Ab}$ des groupes abéliens.
\item La catégorie $\textit{Groups}$ des groupes.
\item Étant donné un groupe $G$, la catégorie $G\textit{-Sets}$ des
...
Un foncteur $F$ de $\mathcal{A}$ dans $\textit{Sets}$
...
foncteurs $\textit{Sets} \to \textit{Sets}$. Avec notre définition actuelle,
...
$F$ de $\mathcal{C}$ dans $\textit{Sets}$.
...
$h_U : \mathcal{C}^{opp} \to \textit{Sets}$.
...
Un foncteur contravariant $F : \mathcal{C}\to \textit{Sets}$ est dit
...
$F : \mathcal{C}^{opp} \to \textit{Sets}$ un foncteur représentable.
...
\begin{enumerate}
\item La catégorie $\textit{Groups}$ des groupes.
\item La catégorie $G\textit{-Sets}$ des ensembles
...
Soit $\mathcal{C}$ une catégorie.
Soient $F, G, H : \mathcal{C}^{opp} \to \textit{Sets}$
...
Soit $\mathcal{C}$ une catégorie.
Soient $F, G : \mathcal{C}^{opp} \to \textit{Sets}$
...
de $\mathcal{C}$ dans $\textit{Sets}$. Si $a$ est représentable
...
Soit $\mathcal{C}$ une catégorie.
Soit $F : \mathcal{C}^{opp} \to \textit{Sets}$ un foncteur.
...
\noindent
Non seulement les limites et les colimites existent dans $\textit{Sets}$,
mais elles sont également faciles à décrire. Soit en effet
$M : \mathcal{I}
\to \textit{Sets}$, $i \mapsto M_i$, un diagramme
...
\medskip\noindent
Supposons que $M : \mathcal{I} \to \textit{Sets}$ soit un diagramme filtrant.
...
Soit $M : \mathcal{I} \times \mathcal{J} \to \textit{Sets}$,
...
d'un diagramme $M : \mathcal{I} \to Sets$ est l'image de l'idempotent $M(e)$.
...
Si $S : \mathcal{I} \to \textit{Sets}$ est un diagramme cofiltrant
...
$A, B : \mathcal{C} \to \textit{Sets}$ définis par
$$
...
les foncteurs $\mathcal{C}^{opp} \times \mathcal{D} \to \textit{Sets}$, allant de
...
\ref{remark-big-categories}.} catégorie qui a des limites. Soit $F : \mathcal{C} \to \textit{Sets}$ un foncteur. Supposons que
\begin{enumerate}
...
\cite[Chapter I, Section 2]{GZ} et \cite[Chapter II, Section 2]{Verdier}.
...
\item La $2$-catégorie des groupoïdes $\textit{Groupoids}$ ; il s'agit d'une
$(2, 1)$-catégorie.
...
Supposons que $F : \mathcal{C}^{opp} \to \textit{Groupoids}$ soit un foncteur
...
Soit $ p : \mathcal{S} \to \mathcal{C}$ une catégorie fibrée en groupoïdes.
Il existe un foncteur contravariant $F : \mathcal{C} \to \textit{Groupoids}$
...
Supposons que $F : \mathcal{C}^{opp} \to \textit{Sets}$ soit un préfaisceau.
Pour $f : V \to U$ dans $\mathcal{C}$, nous écrirons de manière suggestive
$F(f) = f^\ast : F(U) \to F(V)$.
