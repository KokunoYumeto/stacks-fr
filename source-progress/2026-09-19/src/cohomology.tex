...
Nous laissons les vérifications au lecteur. (Alternativement, vérifiez les script signs.gp dans le sous-répertoire scripts du projet Stacks.)
...
et un mod trivial $2$ (Alternativement, vérifiez les script signs.gp dans le sous-répertoire scripts du projet Stacks.)
...
$$
et ainsi dans le colimite aussi un produit sur {\v Cohomologie et donc (en utilisant des hypercouvrages si nécessaire) un produit en cohomologie de ${\mathcal F}^\bullet$. Nous affirmons que ce produit (sur la cohomologie) est classé commutatif ainsi. Pour prouver cela, nous considérons d'abord un élément $\alpha$ du degré $n$ en
$\text{Tot}(\check{\mathcal{C}}^\bullet({\mathcal U}, {\mathcal F}^\bullet))$
et un élément $\beta$ du degré $m$ en
$\text{Tot}(\check{\mathcal{C}}^\bullet({\mathcal U}, {\mathcal F}^\bullet))$
et nous calculons
...
$$
Un calcul immédiat modulo $2$ le vérifie. On peut aussi consulter le script signs.gp dans le sous-répertoire scripts du projet Stacks.
...
0.
$$
Nous avons vu qu'il s'agit d'une suite exacte courte dans la preuve du lemme \ref{lemma-mayer-vietoris}. L'assertion finale découle de la fonctorielité de la construction dans Injectives, théorème
\ref{injectives-theorem-K-injective-embedding-grothendieck}.
...
pour un objet injectif $\mathcal{I}$ de $\textit{Mod}(\mathcal{O}_X)$. L'assertion finale découle de la fonctorielité de la construction dans Injectives, théorème
\ref{injectives-theorem-K-injective-embedding-grothendieck}.
...
\noindent
La construction de la section \ref{section-cech-cohomology-of-complexes} n'est pas la bonne pour les complexes non bornés. Le problème est que, dans le projet Stacks, nous utilisons des sommes directes dans la totalisation d'un complexe double et que nous devrions les remplacer par un produit. Au lieu d'effectuer ce remplacement dans cette section, nous supposons que le recouvrement est fini et nous utilisons le complexe de {\v C}ech alterné.
...
\{\rho_V^U\}_{V \subset U\text{ with }U, V \in \mathcal{B}^*})$. Ce nouveau système satisfait encore la condition (3), par le lemme \ref{lemma-uniqueness} appliqué à la solution $K_{X'}$. Pour ce système, $X = X' \cup U_n$, ce qui nous ramène au cas $n = 2$ traité ci-dessus.
...
\{\rho_V^U\}_{V \subset U\text{ with }U, V \in \mathcal{B}_\alpha^*})$. Ce nouveau système satisfait encore la condition (3), par le lemme \ref{lemma-uniqueness} appliqué à la solution $K_{W_\beta}$. Comme $W_\alpha = W_\beta \cup U_\alpha$, nous sommes ramenés au cas traité dans le lemme \ref{lemma-solution-in-finite-case}.
