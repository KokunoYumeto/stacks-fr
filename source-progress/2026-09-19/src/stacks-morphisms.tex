...
\ref{stacks-properties-section-properties-morphisms}.
(Rappelons que, par défaut, ``représentable'' signifie dans le Stacks Project
...
\begin{proof}
Combiner la Remarque \ref{remark-composition} avec Morphismes d'espaces,
...
\begin{proof}
Combiner la Remarque \ref{remark-base-change} avec Morphismes d'espaces,
...
\begin{proof}
Combiner la Remarque \ref{remark-implication} avec Morphismes d'espaces,
...
Ensuite, $G_x$ est séparé par Compléments sur les groupoïdes dans les espaces,
Lemme \ref{spaces-more-groupoids-lemma-group-scheme-over-field-separated} ;
on en conclut que $G_x$ est un schéma par Compléments sur les groupoïdes dans
...
Notons que $R = U \times_\mathcal{X} U$, voir Groupoïdes dans les espaces,
...
stabilisateur (voir Groupoïdes dans les espaces, Définition
...
sur les groupoïdes dans les espaces, Lemme
\ref{spaces-more-groupoids-lemma-groupoid-on-field-dimension-equal-stabilizer}
...
$U \to \mathcal{X}$. Par Groupoïdes dans les espaces, Lemme
...
formation de $U'$ aux changements de base et Groupoïdes dans les espaces,
Lemme
\ref{spaces-groupoids-lemma-open-over-which-unramified-or-lqf}
...
$$
D'après Properties of Stacks, Lemma
...
est plat en tout point au-dessus de $u$ ; voir Morphisms of Spaces, Lemma
...
Lemme \ref{lemma-base-change-flat}. En composant et en utilisant Morphisms
of Spaces, Lemma \ref{spaces-morphisms-lemma-composition-module-flat}, nous
...
sur $u'$, nous concluons que $U' \to V'$ est plat en $u'$ d'après Morphisms
of Spaces, Lemma \ref{spaces-morphisms-lemma-flat-permanence}.
\end{proof}
...
d'Espaces sur les corps montre que les morphismes
...
sous-jacent est fini et discret (Espaces sur les corps, lemme
...
\section{Types de morphismes dont la propriété est de nature locale pour la topologie \'etale sur la source et pour la topologie lisse sur le but}
