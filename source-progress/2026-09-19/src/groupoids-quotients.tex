...
comme dans Groupoids in Spaces, Lemma
...
sont les morphismes $T \to X$. D'après Groupoids in Spaces, Lemma
\ref{spaces-groupoids-lemma-quotient-stack-objects},
...
\medskip\noindent
D'autre part, d'après Groupoids in Spaces, Lemma
...
\begin{proof}
Voir Categories, Section \ref{categories-section-coequalizers}.
\end{proof}
