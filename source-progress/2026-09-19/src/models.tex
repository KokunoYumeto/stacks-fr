...
\noindent
Une partie des arguments fera intervenir la combinatoire des structures
...
\begingroup
\emergencystretch=2em
On dit que deux types numériques $n,\allowbreak m_i,\allowbreak a_{ij},\allowbreak w_i,\allowbreak g_i$ et
$n',\allowbreak m'_i,\allowbreak a'_{ij},\allowbreak w'_i,\allowbreak g'_i$ sont des {\it types équivalents} s'il
...
l'on a soit $m_iw_i = 1$, soit un membre de gauche de l'inégalité $\geq 0$,
...
$i_1,\allowbreak \ldots,\allowbreak i_6$ tels que
$a_{12},\allowbreak a_{23},\allowbreak a_{34},\allowbreak
a_{45},\allowbreak a_{36}$ soient non nuls, on a
...
$f,\allowbreak g,\allowbreak h,\allowbreak i,\allowbreak
j,\allowbreak k,\allowbreak l$
tels que les nombres
$a_{fg},\allowbreak a_{gh},\allowbreak a_{ij},\allowbreak
a_{jh},\allowbreak a_{kl},\allowbreak a_{lh}$ soient non nuls.
...
j,\allowbreak k,\allowbreak l$
tels que les nombres
$a_{fg},\allowbreak a_{gh},\allowbreak a_{hi},\allowbreak
a_{ij},\allowbreak a_{jk},\allowbreak a_{il}$ soient non nuls.
...
$i_1,\allowbreak \ldots,\allowbreak i_7$ tels que
$a_{12},\allowbreak a_{23},\allowbreak a_{34},\allowbreak
a_{45},\allowbreak a_{56},\allowbreak a_{47}$ soient non nuls,
...
$i_1,\allowbreak \ldots,\allowbreak i_8$ tels que
$a_{12},\allowbreak a_{23},\allowbreak a_{34},\allowbreak
a_{45},\allowbreak a_{56},\allowbreak a_{65},\allowbreak a_{57}$
...
\begin{enumerate}
\item l'ensemble $J \subset \{1, \ldots, n\}$ des indices qui ne sont pas de type $(-2)$
...
Soit $J \subset \{1, \ldots, n\}$ l'ensemble des indices qui ne sont pas de type $(-2)$,
...
Si $A = (a_{ij})$, alors, puisque $\Pic(T) \subset \Coker(A)$
d'après le lemme \ref{lemma-picard-T-and-A}. Il suffit donc de démontrer
le lemme pour $\Coker(A)$.
...
localement de type fini sur $R$, mais nous franchirons
ce pont lorsque nous y arriverons.}
...
De même pour les modèles séparés, les modèles lisses, et en ajouter davantage ici.
On dira que {it $X$ est un modèle régulier de $V$} si $X$ est un modèle
de $V$ et si $X$ est un schéma régulier.
De même pour les modèles normaux, les modèles réduits, et en ajouter davantage ici.
...
sont fermés ; la fermeture du lieu singulier
signifie donc qu'ils sont en nombre fini (puisque $X$ est quasi-compact).
...
est un modèle régulier propre $X$ de $C$ tel que
...
\end{slogan}
Soit $C$ une courbe projective lisse sur $K$ telle que
$H^0(C, \mathcal{O}_C) = K$. Si $X$ est un modèle régulier propre
...
composantes irréductibles de $X'_k$ est exactement inférieur d'une unité au
...
&= \text{longueur}_{\mathcal{O}_{C_i, \xi_i}}
   \mathcal{O}_{X, \xi_i}/(\pi) \\
&= \text{longueur}_{\mathcal{O}_{C_i, \xi_i}}
   \mathcal{O}_{X, \xi_i}/(\pi_i^{a_i}) \\
&= a_i
\end{aligned}
$$
...
comme $\text{Proj}(R[T_0,\allowbreak T_1,\allowbreak T_2]/(T_1T_2 - \pi T_0^2))$. La
...
\medskip\noindent
Initialisation : $D$ possède une seule composante irréductible. Alors
...
\ref{lemma-blowdown-regular-model}. Soient $n,\allowbreak{}m_i,\allowbreak{}a_{ij},\allowbreak{}w_i,\allowbreak{}g_i$ le type
numérique associé à $X$, et $n',\allowbreak{}m'_i,\allowbreak{}a'_{ij},\allowbreak{}w'_i,\allowbreak{}g'_i$ celui associé à
...
\ref{lemma-contract-picard-group} (bien que seule l'injectivité soit jamais
...
supposer que les fibres spéciales de toutes les courbes $X_i$ et $Y_i$ sont
réduites.
...
Cela implique immédiatement qu'il est minimal. Ainsi (1) implique (2).
Pour achever la preuve, il reste à montrer que (2) implique (3). Cela est
clair si le genre de $C$ est $>0$, puisque le modèle minimal est alors
...
$T=(n,\allowbreak{}m_i,\allowbreak{}(a_{ij}),\allowbreak{}w_i,\allowbreak{}g_i)$ le type numérique associé à $X$
