...
projet Stacks et donnerons des démonstrations rigoureuses de tous les énoncés.
...
\text{faisceaux de }
\atop \Lambda\text{-modules localement constants constructibles sur }X_\etale & \leftrightarrow &
\text{ modules finis (discrets) sur }\Lambda\text{ }
\atop \text{ munis d'une action continue de }\pi_1(X, \overline{x})\text{ }\\
\\
(\ell\text{ premier}) & \text{ faisceaux }\ell\text{-adiques} \atop \text{ lisses} &
\leftrightarrow &
\text{un }\mathbf{Z}_\ell
\text{-module }M\text{ de type fini muni d'une action continue}
\atop \pi_1(X, \overline{x})\text{ ; on utilise la topologie }
\ell\text{-adique sur }M
\end{matrix}
$$
...
$$
Le twist de l'action de Galois provient du fait que
